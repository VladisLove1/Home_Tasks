...
if (is_active !== false && is_active !== undefined) {
    console.log("//and if it is TRUE, then we have our 'validation' and 'send' methods available, like you see below");
    newForm.validate();
    newForm.send();
}
else {
    console.log("And if it is FALSE or UNDEFINED, we'll see this message" + " 'Can not be sent or validated until class Components is active'");
}
